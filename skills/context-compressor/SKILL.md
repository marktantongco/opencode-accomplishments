...
description: >
  Compress long contexts preserving critical information. Use when use when reducing context length while keeping essential information
  Triggers on keywords: compression, context, optimization, tokens.
...
Compress long contexts preserving critical information. Uses hierarchical summarization, key entity extraction, and relevance scoring to fit essential context within token limits. This skill provides system-level capabilities that maintain agent state, ensure consistency, and optimize resource usage across sessions and projects.
...
**Input:** "Use when reducing context length while keeping essential information"
...
### Operation
Context Compressor executed successfully

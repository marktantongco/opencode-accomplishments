...
name: superpowers
description: >
  Spec-first development with TDD and sub-agent delegation. Use when use when doing spec-first development or delegating to sub-agents
  Triggers on keywords: tdd, spec, delegation, development.

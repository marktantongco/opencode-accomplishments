...
name: explained-code
description: >
  Beginner-friendly code explanation with analogies and diagrams. Use when use when explaining code to beginners or creating educational content
  Triggers on keywords: explanation, education, analogies, diagrams.
...
Beginner-friendly code explanation with analogies and diagrams. Breaks down complex code into understandable chunks with visual aids and real-world comparisons. This skill provides structured workflows and production-ready patterns that ensure code quality, maintainability, and developer experience.
...
**Input:** "Use when explaining code to beginners or creating educational content"
...
### Approach
Use the established explained code pattern to implement the feature with minimal coupling and maximum testability.

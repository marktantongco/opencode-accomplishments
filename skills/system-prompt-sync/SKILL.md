...
description: >
  Auto-sync AGENTS.md across all git repos on version tags. Use when use when synchronizing system prompts across repositories
  Triggers on keywords: sync, git, agents, automation.
...
Auto-sync AGENTS.md across all git repos on version tags. Maintains consistent operating instructions across projects and ensures agents always have current instructions. This skill provides system-level capabilities that maintain agent state, ensure consistency, and optimize resource usage across sessions and projects.
...
**Input:** "Use when synchronizing system prompts across repositories"
...
### Operation
System Prompt Sync executed successfully

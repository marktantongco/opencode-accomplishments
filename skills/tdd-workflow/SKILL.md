...
name: tdd-workflow
description: >
  Test-driven development workflow — write tests first, watch them fail, write minimal code to pass, refactor with confidence. Red-green-refactor cycles with vertical slice architecture. Use when use when writing code test-first, building with tdd discipline, or creating behavior-focused integration tests
  Triggers on keywords: tdd, testing, red-green-refactor, behavior, integration.
...
Test-driven development workflow — write tests first, watch them fail, implement minimum code to pass, then refactor. Enforces the Red-Green-Refactor cycle. This skill provides structured workflows and production-ready patterns that ensure code quality, maintainability, and developer experience.
...
**Input:** "Use when writing code test-first, building with TDD discipline, or creating behavior-focused integration tests"
...
### Approach
Use the established tdd workflow pattern to implement the feature with minimal coupling and maximum testability.

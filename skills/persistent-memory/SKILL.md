...
description: >
  Structured memory system for agent context continuity. Use when use when maintaining context across sessions or conversations
  Triggers on keywords: memory, context, persistence, continuity.
...
Structured memory system for agent context continuity. Stores, retrieves, and manages long-term memory across sessions using a hierarchical taxonomy with importance scoring and decay rates. This skill provides system-level capabilities that maintain agent state, ensure consistency, and optimize resource usage across sessions and projects.
...
**Input:** "Use when maintaining context across sessions or conversations"
...
### Operation
Persistent Memory executed successfully

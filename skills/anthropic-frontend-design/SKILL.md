...
description: >
  Bold aesthetics for AI-native interfaces, conversational UI, trust-forward design. Use when use when building ai-native or conversational interfaces
  Triggers on keywords: ai, frontend, trust, conversational.
...
Bold aesthetics for AI-native interfaces — conversational UI, streaming responses, and AI feedback patterns. Designs interfaces that feel intelligent, responsive, and trustworthy. This skill provides structured frameworks and production-ready patterns that ensure consistency, accessibility, and performance across all design outputs.
...
1. **Conversational UI patterns** — Provides structured approach
2. **Streaming response design** — Provides structured approach
3. **AI confidence indicators** — Provides structured approach
4. **Progressive disclosure for AI features** — Provides structured approach
5. **Trust-building visual cues** — Provides structured approach
6. **Error and fallback states** — Provides structured approach
...
**Input:** "Use when building AI-native or conversational interfaces"
...
### Overview
Production-ready anthropic frontend design implementation following AI-Native Interface Design patterns.

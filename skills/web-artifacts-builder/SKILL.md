...
description: >
  Single-file HTML artifacts with React + Tailwind, zero dependencies. Use when use when creating self-contained html artifacts or demos
  Triggers on keywords: artifacts, html, react, tailwind.
...
Single-file HTML artifacts with React + Tailwind, zero dependencies. Generate self-contained interactive demos, tools, and visualizations that run in any browser. This skill provides structured workflows and production-ready patterns that ensure code quality, maintainability, and developer experience.
...
**Input:** "Use when creating self-contained HTML artifacts or demos"
...
### Approach
Use the established web artifacts builder pattern to implement the feature with minimal coupling and maximum testability.

...
name: explore
description: >
  Search a codebase using codebase_search tool — saves time and tokens over grep. Use when use when searching a codebase efficiently without grep
  Triggers on keywords: search, codebase, explore, efficiency.
...
Search a codebase using codebase_search tool — saves time and finds the right files quickly. Navigates large codebases efficiently with pattern matching and dependency tracking. This skill provides data extraction, analysis, and research capabilities that turn raw information into actionable insights.
...
**Input:** "Use when searching a codebase efficiently without grep"

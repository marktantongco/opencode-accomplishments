...
description: >
  Step-by-step reasoning framework for complex problems. Use when use when solving complex, multi-step problems requiring explicit reasoning
  Triggers on keywords: reasoning, logic, step-by-step, analysis.

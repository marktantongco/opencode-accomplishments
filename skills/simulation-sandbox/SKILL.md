...
description: >
  Test scenarios in safe simulated environments without real-world consequences. Use when use when testing decisions or exploring scenarios risk-free
  Triggers on keywords: simulation, testing, scenarios, risk.
...
Test scenarios in safe simulated environments without real-world risk. Model outcomes, explore what-if scenarios, and validate hypotheses before committing resources. This skill provides a structured reasoning framework that ensures thorough analysis, reduces cognitive biases, and produces well-supported conclusions.
...
**Input:** "Use when testing decisions or exploring scenarios risk-free"

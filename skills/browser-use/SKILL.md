...
name: browser-use
description: >
  Headful browser automation with natural language control. Use when use when automating browser tasks with natural language commands
  Triggers on keywords: browser, automation, playwright, testing.

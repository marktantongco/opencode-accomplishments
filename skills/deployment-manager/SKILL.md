...
description: >
  Deploy, monitor, update across GitHub Pages, Vercel, Netlify. Use when use when deploying applications or managing infrastructure
  Triggers on keywords: deploy, vercel, netlify, github-pages.
...
Deploy, monitor, update across GitHub Pages, Vercel, Netlify, and Cloudflare Pages. Manages build configurations, environment variables, and deployment pipelines. This skill provides structured workflows and production-ready patterns that ensure code quality, maintainability, and developer experience.
...
**Input:** "Use when deploying applications or managing infrastructure"
...
### Approach
Use the established deployment manager pattern to implement the feature with minimal coupling and maximum testability.

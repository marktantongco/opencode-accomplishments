...
description: >
  Strategic questioning to uncover assumptions and guide discovery. Use when use when coaching, teaching, or guiding someone to discover answers themselves
  Triggers on keywords: questioning, coaching, teaching, discovery.
...
Strategic questioning to uncover assumptions and guide discovery. Uses Socratic dialogue to help users find answers through their own reasoning rather than direct instruction. This skill provides a structured reasoning framework that ensures thorough analysis, reduces cognitive biases, and produces well-supported conclusions.
...
**Input:** "Use when coaching, teaching, or guiding someone to discover answers themselves"

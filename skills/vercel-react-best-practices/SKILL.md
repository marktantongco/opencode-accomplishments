...
description: >
  Production-grade React architecture, hooks patterns, SSR/SSG strategies. Use when use when architecting react apps or optimizing performance
  Triggers on keywords: react, architecture, ssr, performance.
...
Production-grade React architecture, hooks patterns, SSR/SSG strategies, and performance optimization for Next.js applications. This skill provides structured workflows and production-ready patterns that ensure code quality, maintainability, and developer experience.
...
**Input:** "Use when architecting React apps or optimizing performance"
...
### Approach
Use the established vercel react best practices pattern to implement the feature with minimal coupling and maximum testability.
